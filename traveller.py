...
Label(root, text="DOB", bg="#fbe47c",font=(None, 10, 'bold')).place(x=270, y=200)
...
Button(root, text="Add",command = Add,height=3, width= 13).place(x=220, y=360)
Button(root, text="update",command = update,height=3, width= 13).place(x=380, y=360)
Button(root, text="Delete",command = delete,height=3, width= 13).place(x=540, y=360)
